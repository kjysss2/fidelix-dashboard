...
- Winbond·Nanya·Macronix·ESMT: 대만거래소 OpenAPI + 각 사 공식 IR 선행발표 보완 + MOPS 최근 36개월 월매출 그래프(키 불필요)
...
7개사 모두 최근 12개 분기의 매출·영업이익·순이익 막대와 영업이익률·순이익률 점선을 제공합니다. 4분기 값은 연간 누적 실적에서 1~3분기를 차감해 단일 분기로 환산합니다.
